...
{{--  <section class="carosal-area" style="border: 2px solid red;">
		<div class="container">
				<div class="row">
						<div class="col-md-12">
				...
				<div class="row">
						<div class="col-md-12">
								<div class="footer_carosal_icon owl-carousel owl-theme">
										<div class="item">
												<img src="{{url('images/microsoft.png')}}">
										</div>
										<div class="item">
												<img src="{{url('images/envato.png')}}">
										</div>
										<div class="item">
												<img src="{{url('images/yahoo.png')}}">
										</div>
										<div class="item">
												<img src="{{url('images/jquery.png')}}">
										</div>
										<div class="item">
												<img src="{{url('images/amazon.png')}}">
										</div>
								</div>
						</div>
				</div>
