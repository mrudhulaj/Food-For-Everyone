...
<section class="our_activity">
		<h2>OUR ACTIVITY</h2>
		<p>We continuosly strive to provide the best care and feed every needy people out there. Please take a look at our activities and volunteer or contribute in any way you can !</p>
		<div class="container">
				<div class="row">
				...
				<div class="row">
						<div class="col-md-4 col-xs-12">
								<div class="events_single">
										...
										<p><span class="event_left"><i class="material-icons">access_time</i>9:00 am - 2:00 pm</span><span class="event_right"><i class="material-icons">location_on</i>Nagaland</span></p>
										<div class="clear"></div>
										<h3>Angels Orphanage</h3>
										<h6>We are planning a program to engage with our beatiful kids from Angels Orphanage to spend some quality time with them and give them some tasty launch.Click to see more details.</h6>
								</div>
						</div>
						<div class="col-md-4 col-xs-12">
								<div class="events_single">
										<img src="{{url('images/events_single_two.jpg')}}">
										<p><span class="event_left"><i class="material-icons">access_time</i>2:00 pm - 9:00 pm</span><span class="event_right"><i class="material-icons">location_on</i>Chennai</span></p>
										<h3>Goverment Old Age Home</h3>
										<h6>We are planning to visit our charming grandma's and grandpa's at Government Old Age Home, Chennai.We have some amazing activites planned along with a fabulous dinner.Click to see more details</h6>
								</div>
						</div>
						<div class="col-md-4 col-xs-12">
								<div class="events_single">
										<img src="{{url('images/events_single_three.jpg')}}">
										<p><span class="event_left"><i class="material-icons">access_time</i>9:00 pm - 3:00 pm</span><span class="event_right"><i class="material-icons">location_on</i>Kerala</span></p>
										<h3>Mytra School For Special Children</h3>
										<h6>We are planning to see our friends from Mytra School For Special Children, Kerala.We have arranged a grand breakfast and lunch along with some fun games and activities.Click to see more details.</h6>
								</div>
						</div>
				</div>
		</div>
...
<section class="our_cuauses">
		<h2>OUR CAUSES</h2>
		<p>We also believe in investing for a better future for our kids and also to take care of our old pals by building them a place which they deserve.</p>
		<div class="container">
				<div class="row">
						<div class="col-md-12">
				...
				<div class="row">
						<div class="col-md-12">
								<div class="carosal_bottom_single owl-carousel owl-theme">
										<div class="item">
												<img src="{{url('images/volanteer_1.jpg')}}">
												<p>Genuine people,genuine love. Every activity, every transaction is transparent and open for anyone to check.That's what I love about this group. They are happy to answer you questions about donations or any other issues.This is what seperates them from other's.You can be sure your money and effort are going to the right causes here.</p>
										...
										<div class="item">
												<img src="{{url('images/volanteer_2.jpg')}}">
												<p>I have never seen this level of sincerity anywhere else.Kudos to the entire team and organizers for keeping up this wonderful project. I am so happy to be a part of this great team and effort.Looking forward to bringing this mission to even greater heights!</p>
												<h5><i class="material-icons">format_quote</i></h5>
												<h4>Florence M. Cofer</h4>
												<h6>Designer</h6>
										</div>
						...
						<div class="col-md-4">
								<div class="single_news">
										...
										<div class="texts" style="height: 250px;">
												...
												<p class="test">The Billionare and ex chairman of Microsoft announced this in his recent press conference in Washington, USA.</p>
						...
						<div class="col-md-4">
								<div class="single_news">
										...
										<div class="texts" style="height: 250px;">
												...
												<p class="test">The tech conglomerate announced their plans to build a brighter future for the children and elders in their annual conference held at LA, USA.</p>
												<h3><a href="#">READ MORE</a></h3>
										</div>
								</div>
						</div>
						<div class="col-md-4">
								<div class="single_news">
										...
										<div class="texts" style="height: 250px;">
												...
												<p class="test">UN has joined with world leaders and governments to ensure that no child will have to suffer from polio anymore and to completly eradicate it within the next 5 years.</p>
												<h3><a href="#">READ MORE</a></h3>
										</div>
								</div>
						</div>
				...
				<div class="row">
						<div class="col-md-12" style="margin-top: -35px;padding-left: 60px;">
								<div class="footer_carosal_icon owl-carousel owl-theme">
										<div class="item">
												<img src="{{url('images/brand-logos/swiggy.png')}}" style="width: 105;margin-top: 5px;">
										</div>
										<div class="item">
										...
										<div class="item">
												<img src="{{url('images/brand-logos/food-panda.png')}}" style="width: 210px;margin-top: -13px">
										</div>
								</div>
						</div>
				</div>
