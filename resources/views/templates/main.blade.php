							...
							<div class="container">
									<div class="row">
											<div class="col-md-8 col-sm-8 col-xs-12">
													<div class="contact">
															<p><span class="phone join-us"><a href="#">Phone: +91 9998881111</a></span><span class="email join-us"><a href="#">Email: foodforeveryone@gmail.com</a></span></p>
													</div>
											</div>
							...
							<div class="row">
									<div class="col-md-4 col-sm-12">
											<div class="footer-charity-text">
													<h2>Food For Everyone</h2>
													<p>We are a non-profit organization helping restaurents and event planners to distribute their leftover food to the needy people.</p>
													<hr>
											...
											<div class="row">
													<div class="col-md-4 col-sm-5">
															<div class="footer-text one">
																	<h3>RECENT POST</h3>
																	<ul>
																			<li><a href="#"><i class="material-icons">keyboard_arrow_right</i>Volunteers awarded</a></li>
																			<li><a href="#"><i class="material-icons">keyboard_arrow_right</i>Support from Kerala Government</a></li>
																			<li><a href="#"><i class="material-icons">keyboard_arrow_right</i>New restaurents added</a></li>
																			<li><a href="#"><i class="material-icons">keyboard_arrow_right</i>Guide for event planners</a></li>
																			<li><a href="#"><i class="material-icons">keyboard_arrow_right</i>How to minimise food wastage</a></li>
																	</ul>
															</div>
													</div>
													...
													<div class="col-md-4 col-sm-4">
															<div class="footer-text one">
																	<h3>CONTACT US</h3>
																	<ul>
																			<li><a href="#"><i class="material-icons">location_on</i>Emerald Building , Calicut , Kerala , India - 673005</a></li>
																			<li><a href="#"><i class="material-icons">email</i>foodforeveryone@gmail.com</a></li>
