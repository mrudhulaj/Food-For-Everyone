                    ...
                    <div class="input-group col-lg-12">
                      ...
                      <select class="form-control input--style-4" style="" id="country" name="country">
                        ...
                        @foreach ($locationsCountry as $locationsCountryData)
                          <option value="{{$locationsCountryData->CountryID}}" @if($editEvent->Country == $locationsCountryData->Country) selected @endif>{{$locationsCountryData->Country}}</option>
                        @endforeach
                      </select>                    
                    </div>
                    <div class="row row-space" style="padding-right: 0px">
                          ...
                          <div class="input-group col-lg-12 selectbox-div">
                              ...
                              <select class="form-control input--style-4" style="" id="state" name="state">
                                  ...
                                  @foreach ($locationsState as $locationsStateData)
                                    <option @if($editEvent->State == $locationsStateData->State) selected @endif value="{{$locationsStateData->ID}}">{{$locationsStateData->State}}</option>
                                  @endforeach
                              </select>
                          </div>
                      </div>
                            ...
                            <div class="input-group col-lg-12 selectbox-div">
                                ...
                                <select class="form-control input--style-4" style="" id="district" name="district">
                                    ...
                                    @foreach ($locationsDistrict as $locationsDistrictData)
                                      <option @if($editEvent->District == $locationsDistrictData->District) selected @endif value="{{$locationsDistrictData->ID}}">{{$locationsDistrictData->District}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
      ...
      if(isAdminLoggedIn == "Admin"){
        $('#country').change(function(){
          if($(this).val() != ""){
            ...
            ;
            locationsSpecificDataCustom("Country",$(this).val(),"UserMenu");
